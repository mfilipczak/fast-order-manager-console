...
var OrderSearchService = (function () {
    function OrderSearchService(http) {
        this.http = http;
    }
    OrderSearchService.prototype.search = function (term) {
        return this.http
            .get("http://localhost:8080/orders/search/findByExternalId?externalId=" + term)
